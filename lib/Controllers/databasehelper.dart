...
class DatabaseHelper{
  ...
  static String serverUrl = "http://thelastmile.shop/public/api";
  var status ;
  ...
  var token ;
   ...
   registerData(String name ,String fname ,String lname,
       String birthday, String email , String password , var phone) async{

    final String myUrl = "$serverUrl/signup";
    final response = await  http.post(myUrl,
        headers: {
          'Accept':'application/json'
        },
