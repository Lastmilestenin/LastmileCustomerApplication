...
class DistancePrice extends StatefulWidget {
  @override
  _DistancePriceState createState() => _DistancePriceState();
}

class _DistancePriceState extends State<DistancePrice> {
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    Image.asset("assets/distance.png",height: 30,width: 30,color: Color(0xFF145c73),),
                                    Text("Distance",style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),)
                                  ],
                                ),
                              ),
                              Container(height: 40,
